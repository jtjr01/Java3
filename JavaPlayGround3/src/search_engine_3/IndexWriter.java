 ...
 * Purpose: Creates the following files vocab.bin, postins.bin
 * and vocabTable.bin. The vocab.bin will contain the vocabulary 
 * of the entire corpus. The posing.bin will list the postings list of 
 * the document IDs. The vocabTable.bin will map the two previous files 
 * for later usage.
 */
