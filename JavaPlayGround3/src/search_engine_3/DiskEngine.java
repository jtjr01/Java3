 ...
 * Purpose: Create a disk inverted index by using a corpus. Also allow
 * the user to search for multiple words using spaces. Words will be 
 * searched using the create three files during the index. The files 
 * created are the following postings.bin, vocab.bin, and vocabTable.bin.
 */
